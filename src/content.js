  ...
  // ─── 3 ────────────────────────────────────────────────────────────────
  {
    ...
    cards: [
      {
        ...
        bullets: [
          ...
          "Vector relation: U = C + W (equivalently C = U − W and W = U − C). Bridges the rotating and stationary frames.",
        ],
      },
      {
        id: "s3-c2",
        ...
        bullets: [
          ...
          "W1 = U − C1: relative velocity at the rotor blade (per this course's sign convention U = C + W).",
    ...
    probes: [
      ...
      },
      {
        ...
        type: "mcq",
        kind: "concept",
        stem: "From the rotor inlet velocity triangle, what is the correct vector relation between the absolute velocity C, the blade speed U, and the relative velocity W?",
        options: [
          "C = U + W (equivalently W = C − U)",
          "U + C + W = 0",
          "C, U, and W are scalars — no vector relation applies",
          "U = C + W (equivalently C = U − W and W = U − C)",
        ],
        correct: 3,
        explain: "Per this course's sign convention, the closing relation is U = C + W. The three equivalent forms are U = C + W, C = U − W, and W = U − C — they all describe the same vector triangle, just rearranged.",
      },
      {
        id: "s3-p3",
        type: "mcq",
...
export const SUMMATIVE = [
  ...
  },
  {
    ...
    options: ["≈ 838 m/s", "≈ 105 m/s", "≈ 200 m/s", "≈ 419 m/s"],
    correct: 3,
  ...
  },
  {
    ...
    options: ["0.7 mm", "0.035 mm", "0.35 mm (within 0.3–0.5 mm band)", "3.5 mm"],
    correct: 2,
  ...
  },
  {
    ...
    options: ["800 MPa", "≈ 320 MPa", "1200 MPa", "≈ 533 MPa"],
    correct: 3,
